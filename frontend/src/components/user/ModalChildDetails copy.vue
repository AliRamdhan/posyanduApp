...
import ListDetailsChild from "./ListDetailsChild.vue";
...
<template>
  <div>
    <!-- <fwb-button > Open modal </fwb-button> -->
    <button @click="showModal" class="text-sm text-blue-900 font-bold">Perkembangan</button>
